function reconstructCursorMovFromKinect(datadir)
...
% plotReconstructedTrajByTraj(cursor.ind,start.ind,stop.ind,start2.ind,stop2.ind,ReachMetrics.ind.MT,soggetti);

ReachCompleteData = load(['mats',filesep,'ReachCompleteData']);
plotcrossTrajByTraj(ReachCompleteData.ind,start.ind,stop.ind,start2.ind,stop2.ind,ReachMetrics.ind.MT,soggetti);
